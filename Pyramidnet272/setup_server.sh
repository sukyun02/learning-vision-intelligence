...
echo "  nohup python train_server.py --seed 42 --epochs 1800 > logs/seed42.log 2>&1 &"
echo "  nohup python train_server.py --seed 0  --epochs 1800 > logs/seed0.log 2>&1 &"
echo "  nohup python train_server.py --seed 1  --epochs 1800 > logs/seed1.log 2>&1 &"
echo ""
